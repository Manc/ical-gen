...
// 	// toJSON
// } from './tools';
// // import {ICalInternalDateTimeValue} from './types';
...
// 	trigger?: number | Date | null;
// 	triggerBefore?: number | Date | null;
// 	triggerAfter?: number | Date | null;
// 	repeat?: number | null;
...
// 	 * @since 0.2.1
// 	 */
// 	trigger (): number | ICalInternalDateTimeValue | null;
...
// 	 * @since 0.2.1
// 	 */
// 	trigger (trigger: number | Date | null): this;
// 	trigger (trigger?: number | Date | null): this | number | ICalInternalDateTimeValue | null {
...
// 	 * @since 0.2.1
// 	 */
// 	triggerAfter (): number | ICalInternalDateTimeValue | null;
...
// 	 * @since 0.2.1
// 	 */
// 	triggerAfter (trigger: number | ICalInternalDateTimeValue | null): this;
// 	triggerAfter (trigger?: number | ICalInternalDateTimeValue | null): this | number | ICalInternalDateTimeValue | null {
// 		if (trigger === undefined) {
// 			return this.data.trigger;
// 		}
...
// 	 * @alias trigger
// 	 */
// 	triggerBefore (trigger: number | ICalInternalDateTimeValue | null): this;
...
// 	 * @alias trigger
// 	 */
// 	triggerBefore (): number | ICalInternalDateTimeValue | null;
// 	triggerBefore (trigger?: number | ICalInternalDateTimeValue | null): this | number | ICalInternalDateTimeValue | null {
// 		if(trigger === undefined) {
// 			return this.trigger();
// 		}
